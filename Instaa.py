...
|____/_/   \_\_| \_| |_| |___| |_| \___/ 
                                         ''')
    print('@KM8MM')
    tok=('2129324473:AAFaXkXeERIQwlQm7DlCEOgKE50mop-m7gc')
    bot = telebot.TeleBot(tok)
    bot.remove_webhook()
    print('')
    print('[+] روح للبوت وحط كلمه [/Start]')
    check = types.InlineKeyboardButton(text='ابدء الصيد ⭕', callback_data='check')
    ch = types.InlineKeyboardButton(text='قناتي ⭕ ', url='t.me/KM8MM')
    ...
    cb = types.InlineKeyboardButton(text='العراق 🇮🇶', callback_data='iraq')
    kaero = types.InlineKeyboardButton(text='مصر 🇪🇬', callback_data='Egypt')
    cb2 = types.InlineKeyboardButton(text='ليبيا 🇱🇾', callback_data='Libya')

    def countres(message):
        can = types.InlineKeyboardMarkup()
        can.row_width = 1
        can.add(cb, kaero, cb2, ch)
        bot.edit_message_text(chat_id=(message.chat.id), message_id=(message.message_id), text='اختار الدوله التي تريد الصيد عليها ⭕  ', reply_markup=can)
    ...
    def iraq_ch(message, available, bad, pn):
        ...
        aac.row_width = 2
        i1 = types.InlineKeyboardButton(text='[+] صيد ⭕', callback_data='i1')
        i2 = types.InlineKeyboardButton(text='[+] تخمين ⭕', callback_data='i2')
        i2_2 = types.InlineKeyboardButton(text=(f"{bad}"), callback_data='i22')
        i3 = types.InlineKeyboardButton(text='[+] رقم ⭕', callback_data='i3')
    ...
    def libya_ch(message, available, bad, pnsn):
        aac = types.InlineKeyboardMarkup()
        aac.row_width = 2
        i1 = types.InlineKeyboardButton(text='[+] الصيد ⭕', callback_data='i1')
        i2 = types.InlineKeyboardButton(text='[+] التخمين ⭕', callback_data='i2')
        i2_2 = types.InlineKeyboardButton(text=(f"{bad}"), callback_data='i22')
        i3 = types.InlineKeyboardButton(text='[+] الرقم ⭕', callback_data='i3')
        i3_2 = types.InlineKeyboardButton(text=(f"{pnsn}"), callback_data='i32')
        i1_2 = types.InlineKeyboardButton(text=(f"{available}"), callback_data='i12')
        aac.add(i1, i1_2, i2, i2_2, i3, i3_2)
        m = message.chat.id
        bot.edit_message_text(chat_id=(message.chat.id), message_id=(message.message_id), text='\nجاري البحث عن حساب ⭕\nاشترك في القناه لكل جديد⭕ @KM8MM\n', reply_markup=aac)
